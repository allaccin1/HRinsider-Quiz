    ...
    $.dlxQuiz = function ( element, options ) {
      var plugin = this,
        ...
        quizScoreRank_text: {
          ...
          d: "Your mark is [D], However, we believe that you are better than getting this result, repeat the test with more focus",
          f: ".Your mark is [E]و We encourage you to spend more time on learning English"
        },
        ...
        resultsButton: function () {
          $( _quizViewResultsButton ).on( 'click', function () {
            ...
            $.each( questions, function ( index ) {
              ...
              resultsHTML += '<strong>The correct Answer: </strong>';
